...
function addProperty(object, property) {
  ...
  object[property] = null;          // using bracket notation when property is a variable
  return object;
}
...
function invokeMethod(object, method) {
  ...
  object[method]();       // Bracket notation as method is a variable
}
...
function deleteProperty(object, property) {
  ...
  //return the object
  delete object[property];      // bracket notation as we don't know the property name
  return object;
}
